...
| 4 | 4.1–4.42 | 🟡 **IN PROGRESS 2026-09-05** | Ratio-scanned all 42 verses against KN. Chapter 4 shows the heaviest condensation of any chapter checked so far (several verses under 0.25 ratio, one at 0.14). Fixed 12 verses with confirmed severe content loss: **4.13** (varna-vs-jati distinction, color/varna etymology, Vedavyasa/Vidura example, Purusha-Sukta four-body-part rationale — was ~1/7th of KN's length), **4.18** (study-without-experience framing, ant-on-elephant illustration's full context, universe-is-a-point humility teaching, and the karma-lepa theological distinction that was entirely missing), **4.33** (parantapa dual-etymology, why Arjuna's fighting is jnana-yajna not dravya-yajna, Bhagavata quote, partha etymology), **4.22** (meditation/samadhi example, job/salary illustration), **4.29** (prana/apana definitions, breathing-rate/longevity calculation, healing-touch point), **4.30** (full deity-hierarchy enumeration), **4.35** (pranipata/parishprashna/sevaya method, ashtanga-namana description, Newton/intuition analogy, anu-in-anu point), **4.24** (varied arpana examples, fire-as-witness-in-marriage illustration, purohitya example), **4.21** (chitta-as-memory-repository definition), **4.7** (Jarasandha/Narakasura historical detail with specific numbers), **4.17** (Vedavyasa/Pandava-lineage illustration of dharma's difficulty — was only vaguely referenced), **4.12** (Krishna/Allah unity-of-God point). Also spot-checked and confirmed already complete: 4.25, 4.19. Validated (701 keys), scanned clean of leftover Kannada-script fragments, rebuilt. **Remaining for next session:** ~28 verses not yet individually checked — 4.1–4.6, 4.8–4.11, 4.14–4.16, 4.20, 4.23, 4.26–4.28, 4.31–4.32, 4.34, 4.36–4.42. Given the heavy condensation found so far, treat all of these as real candidates for gaps, not just the low-ratio ones. |
