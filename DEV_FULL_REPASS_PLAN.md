...
| 3 | 3.1–3.43 | 🟡 **IN PROGRESS 2026-09-05** | Ratio-scanned all 43 verses against KN. This chapter shows heavier overall condensation than ch.1/2 (many verses at 0.3–0.5 ratio even outside the worst cluster). Checked and fixed 10 verses with confirmed dropped content: **3.42** (missing the full per-organ deity enumeration — surya/chandra/agni/varuna/ashvins/indra/upendra/yama/daksha — behind the indriya>manas>buddhi>paratattva hierarchy), **3.31** (missing the full nitya-anushthana mindset explanation, reduced to one sentence), **3.40** (missing the escalating-desire example: sound→sight→touch craving, and the specific mind-vs-buddhi-invasion distinction), **3.28** (missing the eloquent-speaker illustrative example on the bhava→shabda→speech chain), **3.37** (missing the two-cause explanation for wrongdoing plus the job-seeker's-insatiable-raise example and the brahma-hatya shastra reference), **3.9** (had drifted into unrelated/fabricated dana/sangatikarana content not in KN at all — rewritten to match KN's actual oxygen-breathing/ashvattha-tree/kara-tax etymology content, and Kunti's full backstory), **3.21** (missing the bad-example-spreads-faster-than-good observation and the smoking-teacher illustration), **3.16** (missing the universal-interconnectedness/gratitude-for-food point), **3.34** (missing the closing Lakshmi/friendship-bond line and the Duryodhana/Abhimanyu even-mindedness illustration). Also spot-checked and confirmed already complete: 3.1, 3.2, 3.6, 3.8, 3.30, 3.33, 3.35. Validated (701 keys), scanned clean of leftover Kannada-script fragments, rebuilt. **Remaining for next session:** ~26 verses not yet individually checked — 3.3–3.5, 3.7, 3.10–3.15, 3.17–3.20, 3.22–3.27, 3.29, 3.32, 3.36, 3.38–3.39, 3.41, 3.43 (some of these were spot-checked already: 3.38 looked complete; recheck systematically). |
