...
| 5 | 5.1–5.29 | 🟡 **IN PROGRESS 2026-09-05** | Ratio-scanned all 29 verses against KN. Chapter 5 shows heavy condensation similar to chapter 4 (worst verses under 0.2 ratio). Fixed 7 verses with confirmed content loss: **5.14** (added the king-granting-his-son-authority datta-swatantrya illustration; verse was otherwise already well-covered), **5.21** (restored the "living for tomorrow's happiness" point, sleep-happiness analogy, Upanishad renunciation quote, and the old-woman-searching-under-the-streetlight folk story), **5.18** (severely condensed samadarshana verse — restored the vidya-vinaya-sampanna/vedagya/vedartha-jna distinctions, shvapaka etymology, cow/dog status reasoning, deer-skin meditation aid, touch-me-not plant's medicinal use, honey-bee's inimitable skill), **5.17** (restored the four-quality reasoning, Purandara Dasa quote, and the point on tattvabhimani devatas), **5.20** (restored the attachment-to-suicide-tendency point, prarabdha-karma contrast, mother-child hita-vs-ishta example), **5.15** (restored the vamachara/astrology example, father-son proxy-karma example, prarabdha-disease reasoning), **5.16** (restored the self-inquiry starting point, senses/mind-not-ours discussion, bimba-pratibimba point), **5.22** (restored the gulaganji/kumbalakayi proportion analogy and the "wait till 60" objection setup). Validated (701 keys), scanned clean of leftover Kannada-script fragments, rebuilt. **Remaining for next session:** 5.1–5.10, 5.12–5.13, 5.19, 5.23–5.29 not yet individually checked (5.23 spot-checked and confirmed complete). Given the pattern in this chapter, treat all as real candidates for gaps. |
