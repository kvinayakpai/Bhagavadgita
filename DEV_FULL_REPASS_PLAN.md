...
| 1 | 1.1–1.47 | 🟡 **IN PROGRESS 2026-09-05** | Important nuance found for this chapter: unlike ch.12+, ch.1's DEV was already a *full rewrite from KN* on 2026-07-25 (see `EN_RETRANSLATION_PLAN.md`) in the "condensed Sanskrit prose" house style of that time — not the extremely compressed one-line-per-point style that triggered this whole plan at 12.16. Spot-checked 22 of 47 verses (1.1,1.3,1.5–1.10,1.12,1.14,1.20,1.27,1.31,1.32,1.37,1.42,1.46,1.47 plus the 4 fixed below) against KN in full: most already preserve every sub-argument, backstory, and etymology at a Sanskrit-appropriate (terser than Kannada, ~0.4–0.7 length ratio, not 1:1) level and did **not** need rewriting. Four verses had genuine dropped content and were fixed this session: **1.2** (missing the nine-fold army-division enumeration table, patti→akṣauhiṇī, with troop counts — restored), **1.4** (missing the Gāṇḍīva-bow detail and the three individual backstories of Sātyaki/Virāṭa/Drupada explaining why they ended up on the Pāṇḍava side — restored), **1.40** (missing the jāti/kula-dharma occupation examples, the hospital-silence illustration, the full gurukula/child-marriage historical digression, and the eye-ear "dharma becomes adharma past its limit" illustration — restored), **1.41** (missing the śāstra reasoning on forced female education, its effect on garbhakośa, and the multiple-partner effect on offspring — restored). Validated (701 keys), rebuilt. **Remaining for next session:** verses 1.11, 1.13, 1.15–1.19, 1.21–1.26, 1.28–1.30, 1.33–1.36, 1.38–1.39, 1.43–1.45 have not yet been individually verified against KN — spot-check these before marking the chapter complete. |
