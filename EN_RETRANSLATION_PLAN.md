...
| 2 | 2.1–2.10 | 🔶 Partial (from prior session): 2.3/2.4/2.6 read, no defects beyond expected 2.3 staleness (predates this session's KN paragraph restoration — needs re-audit against restored KN). 2.1/2.2/2.5/2.7–2.10 not yet individually read. | as above | none yet |
...
| 2 | 2.1–2.10 | 🔶 Partial (from prior session): 2.3, 2.4, 2.6 flagged short by automated screen (2.3 expected-stale, same as DEV). Not yet individually read in full. | not yet individually read beyond the automated screen | none yet |
