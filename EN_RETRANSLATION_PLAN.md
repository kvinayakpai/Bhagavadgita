...
| 2 | 72 | 🔶 In progress. 2.1–2.20 verified vs source pages 42–54 (2.16–2.20 checked against pages 51–54, no deviations — matches printed text exactly). Latin-content verses in ch2 identified (9 total via Latin-scan): 2.3, 2.15 (both done, verified as printed), 2.22, 2.44, 2.46, 2.53, 2.54, 2.57, 2.63 (not yet reached). KN fixes noted earlier (2.2, 2.10, 2.3/2.4 paragraph restoration, 2.4 pūjārhā) still stand. **2.11–2.20 stale-EN replaced**: 2.11/2.12 had synthesized content not present in KN (removed per no-synthesis rule); 2.16–2.20 retranslated fresh from verified KN, including 2.16's alternate-reading paragraph (Mahābhārata's "ten meanings per śloka") and 2.20's bracketed aside on the Supreme Puruṣa, both preserved from the source | 2.1–2.20 done | 2.1–2.20 |
| 2 (remaining) | 52 | — | — | — |
| 3–18 | 582 | — | — | — |
...
| 2 | 2.1–2.20 | ✅ 2026-07-25 (2.1–2.10), 2026-07-26 (2.11–2.20). Full rewrite (same rationale as ch1). 2.16–2.20 regenerated as freshly-composed condensed Sanskrit prose from verified KN, same house style. Automated re-screen returns clean across all 20. **Caveat unchanged: not yet reviewed by a native Sanskrit speaker.** | All 20 rewritten | 2.1–2.20 |
...
| 2 | 2.1–2.20 | ✅ 2026-07-25 (2.1–2.10), 2026-07-26 (2.11–2.20). Full rewrite alongside DEV. 2.16–2.20 regenerated from verified KN, mirroring KN/EN structure per Rule 10. Automated re-screen returns clean across all 20. | All 20 rewritten | 2.1–2.20 |
...
This means chapter 2 is now **caught up to the new cadence as of verse 2.20**: EN/DEV/HI are all complete through 2.1–2.20. From 2.21 onward, do all three languages together per verse batch, per the cadence above — no more language gaps within a chapter.
