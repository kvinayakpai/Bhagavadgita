...
| 2 | 2.1–2.10 | ✅ 2026-07-25. Full rewrite (same rationale as ch1 — chose consistency over patching, and 2.3's KN had grown substantially from the paragraph restoration, making the old stale DEV/HI moot anyway). All 10 verses regenerated from verified KN via the same transliteration pipeline + condensed Sanskrit commentary style. Automated re-screen returns clean across all 10. | All 10 rewritten | 2.1–2.10 |
...
| 2 | 2.1–2.10 | ✅ 2026-07-25. Full rewrite alongside DEV, same batch/session. All 10 verses regenerated from verified KN, mirroring KN/EN structure per Rule 10. Automated re-screen returns clean across all 10. | All 10 rewritten | 2.1–2.10 |
...
This means chapter 2 is now **caught up to the new cadence as of verse 2.10**: EN/DEV/HI are all complete through 2.1–2.10. From 2.11 onward, do all three languages together per verse batch, per the cadence above — no more language gaps within a chapter.
